 ...
 * Slug: chairforce/template-search
 * Categories: template
 * Inserter: false
 */
?>
...
<div class="wp-block-group"><!-- wp:search {"label":"<?php esc_html_e( 'Search', 'chairforce' ); ?>","showLabel":false,"placeholder":"<?php esc_attr_e( 'Search...', 'chairforce' ); ?>","width":null,"widthUnit":"%","buttonText":"Search","buttonPosition":"button-inside","buttonUseIcon":true,"align":"center","className":"is-style-swt-search-minimal"} /--></div>
<!-- /wp:group -->
<!-- /wp:query-no-results -->
