...
/* harmony export */   initProductFaqsAccordionAll: () => (/* binding */ initProductFaqsAccordionAll)
/* harmony export */ });
...
function getAccordionDurationMs(root) {
  const duration = window.getComputedStyle(root).getPropertyValue('--cf-accordion-duration');
  if (!duration) {
    return 300;
  }
...
function revealAllAccordionItems(root) {
  const hiddenItems = Array.from(root.querySelectorAll(`.${LOAD_MORE_HIDDEN_CLASS}`));
  ...
  hiddenItems.forEach((item, index) => {
    ...
    item.style.setProperty('--cf-accordion-reveal-delay', `${index * staggerMs}ms`);
  });
  ...
  const cleanupDelay = durationMs + (hiddenItems.length - 1) * staggerMs + 50;
  window.setTimeout(() => {
    hiddenItems.forEach(item => {
      item.classList.remove(LOAD_MORE_REVEAL_CLASS, LOAD_MORE_REVEALED_CLASS);
 ...
 */
function initProductFaqsAccordionAll() {
  initAccordions();
}

/***/ },

/***/ "./src/js/category-swiper.js"
/*!***********************************!*\
  !*** ./src/js/category-swiper.js ***!
  \***********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   bindCategorySwiperListeners: () => (/* binding */ bindCategorySwiperListeners),
/* harmony export */   initCategorySwipers: () => (/* binding */ initCategorySwipers),
/* harmony export */   refreshCategorySwipers: () => (/* binding */ refreshCategorySwipers)
/* harmony export */ });
...
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
/**
...
function initCategorySwiper(root) {
  ...
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperEl, options);
 ...
 */
function initCategorySwipers(scope) {
 ...
 * @param {ParentNode|null|undefined} scope
 */
function refreshCategorySwipers(scope) {
  const context = scope ?? document;
  context.querySelectorAll(ROOT_SELECTOR).forEach(root => {
    if (root instanceof HTMLElement) {
 ...
 */
function bindCategorySwiperListeners() {
  let resizeTimer = 0;
  ...
  document.addEventListener(_shared_delegated_events__WEBPACK_IMPORTED_MODULE_5__.CONTENT_UPDATED_EVENT, event => {
    const detail = event.detail ?? {};
    const scope = detail?.scope instanceof ParentNode ? detail.scope : document;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CONTENT_UPDATED_EVENT: () => (/* reexport safe */ _shared_delegated_events__WEBPACK_IMPORTED_MODULE_14__.CONTENT_UPDATED_EVENT),
/* harmony export */   delegateDocument: () => (/* reexport safe */ _shared_delegated_events__WEBPACK_IMPORTED_MODULE_14__.delegateDocument),
/* harmony export */   delegateOn: () => (/* reexport safe */ _shared_delegated_events__WEBPACK_IMPORTED_MODULE_14__.delegateOn),
/* harmony export */   dispatchContentUpdated: () => (/* reexport safe */ _shared_delegated_events__WEBPACK_IMPORTED_MODULE_14__.dispatchContentUpdated)
/* harmony export */ });
/* harmony import */ var _product_search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product-search */ "./src/js/product-search.js");
/* harmony import */ var _product_filters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product-filters */ "./src/js/product-filters.js");
/* harmony import */ var _product_view_switcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product-view-switcher */ "./src/js/product-view-switcher.js");
/* harmony import */ var _quick_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./quick-view */ "./src/js/quick-view.js");
/* harmony import */ var _shared_load_more__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/load-more */ "./src/js/shared/load-more.js");
/* harmony import */ var _shared_product_card_add_to_cart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/product-card-add-to-cart */ "./src/js/shared/product-card-add-to-cart.js");
/* harmony import */ var _shared_product_grid_swatches__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shared/product-grid-swatches */ "./src/js/shared/product-grid-swatches.js");
/* harmony import */ var _shared_wishlist__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/wishlist */ "./src/js/shared/wishlist.js");
/* harmony import */ var _single_product_swatches__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./single-product-swatches */ "./src/js/single-product-swatches.js");
/* harmony import */ var _product_reviews_form_toggle__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./product-reviews-form-toggle */ "./src/js/product-reviews-form-toggle.js");
/* harmony import */ var _accordion__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./accordion */ "./src/js/accordion.js");
/* harmony import */ var _category_swiper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./category-swiper */ "./src/js/category-swiper.js");
/* harmony import */ var _site_header__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./site-header */ "./src/js/site-header.js");
/* harmony import */ var _woocommerce_quantity__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./woocommerce-quantity */ "./src/js/woocommerce-quantity.js");
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
...
document.addEventListener('DOMContentLoaded', () => {
  (0,_site_header__WEBPACK_IMPORTED_MODULE_12__.initSiteHeader)();
  (0,_product_search__WEBPACK_IMPORTED_MODULE_0__.initProductSearchForms)();
  (0,_shared_product_grid_swatches__WEBPACK_IMPORTED_MODULE_6__.initProductGridSwatches)();
  (0,_single_product_swatches__WEBPACK_IMPORTED_MODULE_8__.initSingleProductSwatches)();
  (0,_product_reviews_form_toggle__WEBPACK_IMPORTED_MODULE_9__.initProductReviewsFormToggle)();
  (0,_accordion__WEBPACK_IMPORTED_MODULE_10__.initAccordions)();
  (0,_category_swiper__WEBPACK_IMPORTED_MODULE_11__.initCategorySwipers)();
  (0,_category_swiper__WEBPACK_IMPORTED_MODULE_11__.bindCategorySwiperListeners)();
  (0,_quick_view__WEBPACK_IMPORTED_MODULE_3__.initQuickView)();
  (0,_product_filters__WEBPACK_IMPORTED_MODULE_1__.initProductFilters)();
  (0,_product_view_switcher__WEBPACK_IMPORTED_MODULE_2__.initProductViewSwitcher)();
  (0,_shared_load_more__WEBPACK_IMPORTED_MODULE_4__.initLoadMore)();
  (0,_shared_product_card_add_to_cart__WEBPACK_IMPORTED_MODULE_5__.initProductCardAddToCart)();
  (0,_shared_wishlist__WEBPACK_IMPORTED_MODULE_7__.initWishlist)();
  (0,_woocommerce_quantity__WEBPACK_IMPORTED_MODULE_13__.initWooCommerceQuantity)();
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductFilters: () => (/* binding */ initProductFilters)
/* harmony export */ });
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
/**
...
const SORT_SELECT_SELECTOR = '.wp-block-woocommerce-catalog-sorting select.orderby, .wc-block-catalog-sorting select.orderby';
const OPEN_CLASS = 'is-open';
...
function getArchiveLayout(root) {
  return root?.closest(LAYOUT_SELECTOR) || document.querySelector(LAYOUT_SELECTOR);
}
...
function syncPanelOrientationClasses(root) {
  ...
  panel.classList.remove('cf-filters-panel--vertical', 'cf-filters-panel--horizontal');
...
function getFilterPanelHost(root) {
  ...
  if (getActivePanelOrientation(root) === 'horizontal') {
    return root.querySelector('.cf-shop-archive-filters-band > .alignwide') || root.querySelector('.cf-shop-archive-filters-band') || root;
  }
...
function syncVerticalOverlayHtmlClass(isOpen) {
  ...
  document.documentElement.classList.toggle(VERTICAL_OPEN_HTML_CLASS, isOpen && shouldPortalVerticalPanel(root));
}
...
function setFiltersSwapping(swapping) {
  const root = getFiltersRoot();
  document.documentElement.classList.toggle(SWAPPING_HTML_CLASS, swapping && shouldPortalVerticalPanel(root));
}
...
function buildCatalogUrl(params, options = {}) {
  ...
  return query ? `${getCatalogBasePath()}?${query}` : getCatalogBasePath();
}
...
function parseCatalogOrderby(orderby, order) {
  ...
  if (parts.length >= 2 && /^(asc|desc)$/i.test(parts[parts.length - 1])) {
...
function getPanelRestoreState(root) {
  ...
  const activeCard = root.querySelector(`${BAR_BUTTON_SELECTOR}.is-active`)?.getAttribute('data-filter-card') || panel?.querySelector(`${FILTER_SECTION_SELECTOR}.${ACCORDION_OPEN_CLASS}`)?.getAttribute('data-filter-card') || null;
  return {
    wasOpen,
    activeCard
  };
...
function applyArchiveShellHtml(html, options = {}) {
  ...
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.dispatchContentUpdated)({
    source: 'filters'
  });
}
...
function syncAccordionToggleState(panel) {
  ...
  const allOpen = sections.length > 0 && [...sections].every(section => section.classList.contains(ACCORDION_OPEN_CLASS));
  toggle.classList.toggle(ACCORDION_ALL_EXPANDED_CLASS, allOpen);
  toggle.setAttribute('aria-expanded', allOpen ? 'true' : 'false');
  toggle.setAttribute('aria-label', allOpen ? 'Collapse all filter sections' : 'Expand all filter sections');
}
...
function openAccordionForCard(root, cardSlug, options = {}) {
  ...
  if (root) {
    root.querySelectorAll(BAR_BUTTON_SELECTOR).forEach(button => {
      button.classList.toggle('is-active', button.getAttribute('data-filter-card') === cardSlug);
    });
  }
}
...
function openPanelForCard(root, cardSlug) {
  root.querySelectorAll(BAR_BUTTON_SELECTOR).forEach(button => {
    button.classList.toggle('is-active', button.getAttribute('data-filter-card') === cardSlug);
    button.setAttribute('aria-expanded', button.getAttribute('data-filter-card') === cardSlug ? 'true' : 'false');
  });
...
function toggleFilterTermInParams(filterName, termSlug, params) {
  const current = (params.get(filterName) || '').split(',').map(slug => slug.trim()).filter(Boolean);
...
async function handleClearClick(event, button) {
  event.preventDefault();
  const clearUrl = button.getAttribute('data-clear-url') || button.closest(ROOT_SELECTOR)?.dataset.clearUrl || window.location.pathname;
  await refreshCatalogFromUrl({
    push: true,
...
function handleAccordionTriggerClick(event, trigger) {
  ...
  setAccordionSectionOpen(section, !section.classList.contains(ACCORDION_OPEN_CLASS));
  syncAccordionToggleState(getFilterPanel());
}
...
function handleDocumentClick(event) {
  ...
  if (target.closest(PANEL_SELECTOR) || target.closest(BAR_BUTTON_SELECTOR)) {
    return;
  }
  const root = getFiltersRoot();
  if (root) {
  ...
  if (root) {
    ...
    mq?.addEventListener('change', () => {
      ...
      if (panel?.classList.contains(OPEN_CLASS)) {
        ...
        document.documentElement.classList.toggle('cf-filters-open', !isDesktopVerticalPushMode(root));
      }
    });
  }
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', BAR_BUTTON_SELECTOR, handleBarButtonClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', TERM_SELECTOR, handleFilterTermClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', CHIP_SELECTOR, handleChipClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', CLEAR_SELECTOR, handleClearClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', PRICE_APPLY_SELECTOR, handlePriceApplyClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', PANEL_CLOSE_SELECTOR, handlePanelCloseClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', ACCORDION_TRIGGER_SELECTOR, handleAccordionTriggerClick);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', ACCORDION_TOGGLE_SELECTOR, handleAccordionToggleClick);
  document.addEventListener('click', handleDocumentClick);
  document.addEventListener('keydown', handleEscapeKey);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('change', SORT_SELECT_SELECTOR, handleSortChange, true);
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('submit', '.wp-block-woocommerce-catalog-sorting form, .wc-block-catalog-sorting form', event => {
    if (!isProductArchivePage()) {
      return;
    }
    event.preventDefault();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductReviewsFormToggle: () => (/* binding */ initProductReviewsFormToggle)
/* harmony export */ });
/**
 * Reveal the review form when Write a Review is clicked.
 */
function initProductReviewsFormToggle() {
  const section = document.getElementById('reviews');
  if (!section) {
    return;
  }
  const formWrapper = section.querySelector('.cf-product-reviews__form-wrapper');
  const writeReviewButtons = document.querySelectorAll('[data-cf-show-review-form]');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductSearchForms: () => (/* binding */ initProductSearchForms)
/* harmony export */ });
/**
...
function initProductSearch(form) {
  ...
  let activeIndex = -1;
  const restBase = window.Chairforce_Public?.rest_url || `${window.location.origin}/wp-json/chairforce/v1/product-search`;
  const closeResults = () => {
    list.hidden = true;
    list.innerHTML = '';
    input.setAttribute('aria-expanded', 'false');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductViewSwitcher: () => (/* binding */ initProductViewSwitcher)
/* harmony export */ });
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
/**
...
function getArchiveMains() {
  ...
  return Array.from(document.querySelectorAll(MAIN_SELECTOR)).filter(node => node instanceof HTMLElement);
}
...
function applyView(view) {
  ...
  document.querySelectorAll(BUTTON_SELECTOR).forEach(button => {
    ...
    button.classList.toggle('cf-product-view-switcher__button--active', buttonView === view);
  });
}
...
function initProductViewSwitcher() {
  if (!document.querySelector(SWITCHER_SELECTOR)) {
    return;
  }
  applyView(getStoredView());
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', BUTTON_SELECTOR, (event, button) => {
    if (!(button instanceof HTMLButtonElement)) {
      return;
    }
    event.preventDefault();
  ...
  document.addEventListener(_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.CONTENT_UPDATED_EVENT, () => {
    applyView(getStoredView());
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initQuickViewDetails: () => (/* binding */ initQuickViewDetails)
/* harmony export */ });
/**
...
const DESCRIPTION_CONTENT_SELECTOR = '.cf-quick-view-details--description .cf-quick-view-details__content';
...
function initQuickViewDescriptionElement(content) {
  ...
  const expand = () => {
    if (!content.classList.contains('cf-quick-view-details__content--collapsible')) {
      return;
    }
 ...
 */
function initQuickViewDetails(root) {
  if (!root) {
    return;
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   bindQuickViewGalleryListeners: () => (/* binding */ bindQuickViewGalleryListeners),
/* harmony export */   initQuickViewGalleries: () => (/* binding */ initQuickViewGalleries)
/* harmony export */ });
...
function getSlideDataFromImage(img) {
  return {
    src: img.dataset.largeImage || img.getAttribute('data-large_image') || img.dataset.src || img.getAttribute('data-src') || img.currentSrc || img.src,
    alt: img.alt || '',
    srcset: img.srcset || '',
    sizes: img.sizes || ''
  };
...
function collectGallerySlides(gallery) {
  const slides = [];
  gallery.querySelectorAll('.woocommerce-product-gallery__image').forEach(imageWrap => {
...
function destroyQuickViewGallery(gallery) {
  ...
  gallery.classList.remove('cf-quick-view-gallery', 'cf-quick-view-gallery--ready');
...
function renderQuickViewGallery(gallery, slides) {
  const slideMarkup = slides.map(slide => {
    const srcsetAttr = slide.srcset ? ` srcset="${slide.srcset}"` : '';
  ...
  const navMarkup = slides.length > 1 ? `
			...
			`.trim() : '';
  const paginationMarkup = slides.length > 1 ? '<div class="swiper-pagination cf-quick-view-gallery__pagination"></div>' : '';
  gallery.innerHTML = `
  ...
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](swiperEl, {
    ...
    navigation: {
      prevEl: gallery.querySelector('.cf-quick-view-gallery__nav--prev'),
      nextEl: gallery.querySelector('.cf-quick-view-gallery__nav--next')
    },
    pagination: {
...
function initQuickViewGalleryElement(gallery) {
  ...
  if (gallery.dataset.cfQuickViewGallerySlidesKey === slidesKey && gallery.classList.contains('cf-quick-view-gallery--ready')) {
    return;
  }
 ...
 * @param {ParentNode|null|undefined} root
 */
function initQuickViewGalleries(root) {
  if (!root) {
    return;
  }
 ...
 */
function bindQuickViewGalleryListeners() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('found_variation', '.cf-quick-view__content .variations_form', (event, variation) => {
    ...
    window.setTimeout(() => {
      ...
      gallery.dataset.cfQuickViewGallerySlidesKey = String(variation.image.src);
    }, 0);
  });
}
...
function getGalleryForForm(form) {
  ...
  if (productRoot) {
    const scoped = productRoot.querySelector('.woocommerce-product-gallery, .cf-quick-view-gallery');
    if (scoped) {
      return scoped;
    }
  }
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
/* harmony import */ var _quick_view_gallery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./quick-view-gallery */ "./src/js/quick-view-gallery.js");
/* harmony import */ var _quick_view_details__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./quick-view-details */ "./src/js/quick-view-details.js");
/* harmony import */ var _single_product_swatches__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./single-product-swatches */ "./src/js/single-product-swatches.js");
/**
...
function setLoading(loading) {
  ...
  if (loading && content) {
    content.innerHTML = '<div class="cf-quick-view__loader" role="status"><span class="screen-reader-text">Loading product…</span></div>';
  }
}
...
function finalizeQuickViewContent(content) {
  (0,_single_product_swatches__WEBPACK_IMPORTED_MODULE_4__.primeVariationForms)(content);
  (0,_quick_view_gallery__WEBPACK_IMPORTED_MODULE_2__.initQuickViewGalleries)(content);
  (0,_quick_view_details__WEBPACK_IMPORTED_MODULE_3__.initQuickViewDetails)(content);
}
...
function initQuickViewProductScripts(root) {
  const $root = jquery__WEBPACK_IMPORTED_MODULE_0___default()(root);
...
async function handleTriggerClick(event, trigger) {
  ...
  setLoading(true);
  try {
    const response = await fetch(`${String(restBase).replace(/\/$/, '')}/${productId}`, {
      headers: {
...
function handleShellClick(event) {
  const target = event.target;
  if (target instanceof HTMLElement && target.closest('[data-cf-quick-view-close]')) {
    event.preventDefault();
    closeShell();
  }
}
...
function handleTransitionEnd(event) {
  if (!shellRoot || shellRoot.classList.contains('is-open') || !isClosing || event.target !== getPanelEl()) {
    return;
  }
  finishClose();
}
...
function initQuickView() {
  (0,_quick_view_gallery__WEBPACK_IMPORTED_MODULE_2__.bindQuickViewGalleryListeners)();
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_1__.delegateDocument)('click', '.cf-quick-view-trigger', handleTriggerClick);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CONTENT_UPDATED_EVENT: () => (/* binding */ CONTENT_UPDATED_EVENT),
/* harmony export */   delegateDocument: () => (/* binding */ delegateDocument),
/* harmony export */   delegateOn: () => (/* binding */ delegateOn),
/* harmony export */   dispatchContentUpdated: () => (/* binding */ dispatchContentUpdated)
/* harmony export */ });
/**
...
const CONTENT_UPDATED_EVENT = 'chairforce:content-updated';
 ...
 */
function dispatchContentUpdated(detail = {}) {
  document.dispatchEvent(new CustomEvent(CONTENT_UPDATED_EVENT, {
    bubbles: true,
    detail
  }));
}
 ...
 */
function delegateDocument(eventType, selector, handler, options) {
 ...
 */
function delegateOn(root, eventType, selector, handler, options) {
  if (!root) {
    return null;
  }
  const listener = event => {
...
/* harmony export */ });
/* harmony import */ var _delegated_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./delegated-events */ "./src/js/shared/delegated-events.js");
/**
...
const ARCHIVE_SHELL_QUERY_ARG = '_cf_archive';
const RESULTS_COUNT_SELECTOR = '.wp-block-woocommerce-product-results-count .woocommerce-result-count, .wc-block-product-results-count .woocommerce-result-count';
...
function getSortParamsFromUrl() {
  const params = new URLSearchParams(window.location.search);
  return parseCatalogOrderby(params.get('orderby'), params.get('order'));
}
...
function getSortParamsFromButton(button) {
  ...
  if (raw) {
    try {
      ...
      const fromVars = parseCatalogOrderby(typeof vars.orderby === 'string' ? vars.orderby : null, typeof vars.order === 'string' ? vars.order : null);
      if (fromVars.orderby) {
        return fromVars;
      }
    } catch {
...
function buildCatalogPageUrl(page, button) {
  ...
  if (!params.has('orderby')) {
    const {
      orderby,
      order
    } = getSortParamsFromButton(button);
    if (orderby) {
...
function parseProductItemsFromPageHtml(html) {
  ...
  let total = parseInt(doc.querySelector(`${LOAD_MORE_SELECTOR}`)?.dataset?.total || '0', 10);
  if (!total) {
...
function getViewingStatusText(viewing, total) {
  const template = window.Chairforce_Public?.loadMoreViewingStatus || 'Viewing %1$s of %2$s';
  return template.replace('%1$s', formatNumber(viewing)).replace('%2$s', formatNumber(total));
}
...
function getResultsCountText(viewing, total) {
  ...
  const template = i18n.resultsCountRange || 'Showing %1$s–%2$s of %3$s results';
  return template.replace('%1$s', formatNumber(1)).replace('%2$s', formatNumber(viewing)).replace('%3$s', formatNumber(total));
}
...
function updateLoadMoreProgress(container, viewing, total) {
  ...
  if (progress) {
    ...
    progress.setAttribute('aria-label', getViewingStatusText(viewing, total));
  }
  if (progressBar) {
...
function syncLoadMoreState(loadMoreContainer, list, totalOverride) {
  ...
  const total = totalOverride || parseInt(loadMoreContainer?.dataset.total || '0', 10) || viewing;
...
async function handleLoadMoreClick(event, button) {
  ...
  try {
    ...
    const {
      items,
      total: fetchedTotal
    } = parseProductItemsFromPageHtml(html);
    if (items.length) {
      appendProductItems(list, items);
      (0,_delegated_events__WEBPACK_IMPORTED_MODULE_0__.dispatchContentUpdated)({
        source: 'load-more',
        page: nextPage
      });
    }
    const total = fetchedTotal || parseInt(loadMoreContainer.dataset.total || '0', 10);
    const {
      viewing
    } = syncLoadMoreState(loadMoreContainer, list, total);
...
function initLoadMore() {
  (0,_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', BUTTON_SELECTOR, handleLoadMoreClick);
}

/***/ },

/***/ "./src/js/shared/product-card-add-to-cart.js"
/*!***************************************************!*\
  !*** ./src/js/shared/product-card-add-to-cart.js ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductCardAddToCart: () => (/* binding */ initProductCardAddToCart)
/* harmony export */ });
/* harmony import */ var _delegated_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./delegated-events */ "./src/js/shared/delegated-events.js");
/**
...
const BUTTON_SELECTOR = '.cf-add-to-cart .ajax_add_to_cart[data-product_id]';
...
function getInCartLabel(quantity) {
  const template = window.Chairforce_Public?.inCartLabel || '%d in cart';
...
function syncProductCardAddToCartLabels(root = document) {
  ...
  root.querySelectorAll(BUTTON_SELECTOR).forEach(button => {
    ...
    const quantity = Number.isFinite(productId) ? quantities[productId] || 0 : 0;
...
function initProductCardAddToCart() {
  ...
  if (typeof jQuery !== 'undefined') {
    jQuery(document.body).on('added_to_cart removed_from_cart wc_fragments_loaded wc_fragments_refreshed', sync);
  }
  document.addEventListener(_delegated_events__WEBPACK_IMPORTED_MODULE_0__.CONTENT_UPDATED_EVENT, event => {
...
/***/ "./src/js/shared/product-grid-swatches.js"
/*!************************************************!*\
  !*** ./src/js/shared/product-grid-swatches.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initProductGridSwatches: () => (/* binding */ initProductGridSwatches)
/* harmony export */ });
/* harmony import */ var _delegated_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./delegated-events */ "./src/js/shared/delegated-events.js");
/**
...
const PRODUCT_CARD_SELECTOR = '.wc-block-product, .product-grid-item, .product-teaser';
...
function getProductImage(product) {
  return product.querySelector('.wc-block-components-product-image img, .product-image-link > img, .product-image-link > picture > img');
}
...
function swapProductImage(swatch) {
  ...
  swatchGroup?.querySelectorAll('.cf-swatch--active').forEach(activeSwatch => {
  ...
  const pictureSource = product.querySelector('.wc-block-components-product-image picture source, .product-image-link picture source');
...
function handleSwatchActivate(swatch) {
  ...
  if (group?.classList.contains('cf-swatches--limited') && !group.classList.contains('cf-swatches--all-shown')) {
 ...
 */
function initProductGridSwatches() {
  if (productGridSwatchesInitialized) {
    return;
  }
  productGridSwatchesInitialized = true;
  (0,_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', DIVIDER_SELECTOR, (event, divider) => {
    event.preventDefault();
    expandSwatches(divider);
  });
  (0,_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', SWATCH_SELECTOR, (event, swatch) => {
    event.preventDefault();
    handleSwatchActivate(swatch);
  });
  if (!isTouchDevice()) {
    (0,_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('mouseover', SWATCH_SELECTOR, (event, swatch) => {
...
function getLoginRedirectUrl(fallback) {
  ...
  try {
    ...
    const redirectParam = url.pathname.includes('my-account') || url.pathname.includes('myaccount') ? 'redirect' : 'redirect_to';
...
function initWishlist() {
  ...
  (0,_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', '.cf-wishlist-trigger', (event, button) => {
    event.preventDefault();
...
/***/ "./src/js/single-product-swatches.js"
/*!*******************************************!*\
  !*** ./src/js/single-product-swatches.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   bindSingleProductSwatchListeners: () => (/* binding */ bindSingleProductSwatchListeners),
/* harmony export */   initSingleProductSwatches: () => (/* binding */ initSingleProductSwatches),
/* harmony export */   primeVariationForms: () => (/* binding */ primeVariationForms)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
 ...
 * swap the main gallery when a variation has a multi-image gallery.
 *
 * Gallery HTML comes from WooCommerce's native gallery_images_html field, which
 * is populated by the Variation Gallery feature (Settings → Advanced → Features).
 * Data is sourced from _product_image_gallery on each variation post, migrated
 * from the legacy Woodmart meta by the BatchPress normalisation job.
 *
...
function dispatchQuickViewGalleryChanged(form) {
  ...
  form.dispatchEvent(new CustomEvent('cf:quick-view-gallery-changed', {
    bubbles: true
  }));
}
 ...
 */
function getGalleryForForm(form) {
  const productRoot = form.closest('.product') || form.closest('.wp-block-woocommerce-add-to-cart-form')?.parentElement;
  if (productRoot) {
    const scoped = productRoot.querySelector('.woocommerce-product-gallery');
    if (scoped) {
      return scoped;
    }
  }
...
function replaceProductGallery(form, galleryHtml, variation) {
  ...
  if (typeof $form.wc_variations_gallery_replace === 'function' && galleryHtml) {
    const replaced = Boolean($form.wc_variations_gallery_replace(galleryHtml, variation));
    if (replaced) {
  ...
  const newGallery = template.content.querySelector('.woocommerce-product-gallery');
  if (!newGallery) {
    return false;
  }
  gallery.replaceWith(newGallery);
  if (!isQuickViewForm(form)) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(newGallery).wc_product_gallery();
  }
...
function syncActiveSwatches(form) {
  form.querySelectorAll('.cf-swatches-single').forEach(group => {
    ...
    group.querySelectorAll('.cf-swatch').forEach(swatch => {
      swatch.classList.toggle('cf-swatch--active', swatch.dataset.value === selectedValue);
    });
  });
}
...
function syncSwatchDisabledState(form) {
  form.querySelectorAll('.cf-swatches-single').forEach(group => {
    ...
    group.querySelectorAll('.cf-swatch').forEach(swatch => {
      ...
      const isEnabled = option && !option.disabled && !option.classList.contains('disabled');
 ...
 *
 * Prefers WC's native gallery_images_html (available when the Variation Gallery
 * feature is enabled). Falls back to cf_variation_gallery_html, which is always
 * generated by add_variation_gallery_html() reading from _product_image_gallery
 * (WC native, post-migration) or wd_additional_variation_images_data (Woodmart).
 *
...
function handleFoundVariation(event, variation) {
  const form = event.currentTarget;
  const galleryHtml = variation?.gallery_images_html || variation?.cf_variation_gallery_html;
  if (!form || !galleryHtml) {
    return;
  }
  const state = getFormState(form);
  const replaced = replaceProductGallery(form, String(galleryHtml), variation);
 ...
 */
function bindSingleProductSwatchListeners() {
  if (swatchListenersBound) {
    return;
  }
  swatchListenersBound = true;
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_1__.delegateDocument)('click', '.cf-swatches-single .cf-swatch', handleSwatchClick);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('found_variation', '.variations_form', handleFoundVariation);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('reset_data', '.variations_form', handleResetData);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('woocommerce_update_variation_values', '.variations_form', handleVariationValuesUpdated);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.variations_form .reset_variations', handleResetVariationsClick);
}
 ...
 * @param {ParentNode} [root]
 */
function primeVariationForms(root = document) {
 ...
 */
function initSingleProductSwatches() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initSiteHeader: () => (/* binding */ initSiteHeader)
/* harmony export */ });
/**
...
function updateMobileDrawerOffset() {
  ...
  document.documentElement.style.setProperty('--site-header-primary-bottom', `${primary.getBoundingClientRect().bottom}px`);
}
function initMobileDrawer() {
  ...
  window.addEventListener('scroll', updateMobileDrawerOffset, {
    passive: true
  });
}
function initMobileStickyPrimary() {
  ...
  const updateSpacerHeight = () => {
    ...
    document.documentElement.style.setProperty('--site-header-primary-spacer-height', isStuck && mobileQuery.matches ? `${primary.offsetHeight}px` : '0px');
    updateMobileDrawerOffset();
  };
...
/***/ "./src/js/woocommerce-quantity.js"
/*!****************************************!*\
  !*** ./src/js/woocommerce-quantity.js ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initWooCommerceQuantity: () => (/* binding */ initWooCommerceQuantity)
/* harmony export */ });
/* harmony import */ var _shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/delegated-events */ "./src/js/shared/delegated-events.js");
/**
 ...
 */
function initWooCommerceQuantity() {
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', '.cf-qty-button--minus', (event, button) => {
    event.preventDefault();
  ...
  (0,_shared_delegated_events__WEBPACK_IMPORTED_MODULE_0__.delegateDocument)('click', '.cf-qty-button--plus', (event, button) => {
    event.preventDefault();
    const input = button.closest('.quantity')?.querySelector('.qty');
    if (input instanceof HTMLInputElement && !input.readOnly) {
      stepQuantity(input, 1);
